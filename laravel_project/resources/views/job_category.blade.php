...
@section('content')
    ...
    <div class="container mx-auto px-4 py-12 mt-14">
        <div class="text-center mb-12">
            ...
            <p class="text-gray-600 max-w-3xl mx-auto">Here you can browse the latest job listings related to your field and specialization</p>
        </div>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
            ...
            <div class="category-card p-6 text-center">
                <div class="category-icon mb-4">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64" fill="currentColor">
                        <path d="M42,16H22c-1.1,0-2,0.9-2,2v20c0,1.1,0.9,2,2,2h20c1.1,0,2-0.9,2-2V18C44,16.9,43.1,16,42,16z"/>
                        <path d="M48,42H16c-1.1,0-2,0.9-2,2v2c0,1.1,0.9,2,2,2h32c1.1,0,2-0.9,2-2v-2C50,42.9,49.1,42,48,42z"/>
            ...
            <div class="category-card p-6 text-center">
                <div class="category-icon mb-4">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64" fill="currentColor">
                        <path d="M42,16H22c-1.1,0-2,0.9-2,2v24c0,1.1,0.9,2,2,2h20c1.1,0,2-0.9,2-2V18C44,16.9,43.1,16,42,16z"/>
                        <path d="M48,46H16c-1.1,0-2,0.9-2,2v4c0,1.1,0.9,2,2,2h32c1.1,0,2-0.9,2-2v-4C50,46.9,49.1,46,48,46z"/>
            ...
            <div class="category-card p-6 text-center">
                <div class="category-icon mb-4">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64" fill="currentColor">
                        <path d="M44,24H20c-1.1,0-2,0.9-2,2v4c0,1.1,0.9,2,2,2h24c1.1,0,2-0.9,2-2v-4C46,24.9,45.1,24,44,24z"/>
                        <path d="M30,38H20c-1.1,0-2,0.9-2,2v4c0,1.1,0.9,2,2,2h10c1.1,0,2-0.9,2-2v-4C32,38.9,31.1,38,30,38z"/>
                        <path d="M44,38H34c-1.1,0-2,0.9-2,2v4c0,1.1,0.9,2,2,2h10c1.1,0,2-0.9,2-2v-4C46,38.9,45.1,38,44,38z"/>
