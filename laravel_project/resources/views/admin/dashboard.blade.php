...
<div class="mt-8">
  <div class="bg-white rounded-lg shadow-md overflow-hidden">
    ...
    <div class="p-6 space-y-4 activity-feed">
      <div class="feed-item flex items-start">
        ...
        <div class="ml-4 flex-1">
          <p class="text-sm text-gray-800">
            New job <span class="font-semibold">"Software Engineer"</span> posted
          </p>
      ...
      <div class="feed-item flex items-start">
        ...
        <div class="ml-4 flex-1">
          <p class="text-sm text-gray-800">
            Employer <span class="font-semibold">"TechCorp"</span> registered
          </p>
      ...
      <div class="feed-item flex items-start">
        ...
        <div class="ml-4 flex-1">
          <p class="text-sm text-gray-800">
            New candidate <span class="font-semibold">"John Smith"</span> applied to <span class="font-semibold">"UI Designer"</span>
          </p>
          <p class="text-xs text-gray-500 mt-1">35 mins ago</p>
        </div>
        <div class="flex-shrink-0">
          <button class="text-gray-400 hover:text-gray-600">
            <i class="fas fa-ellipsis-v"></i>
