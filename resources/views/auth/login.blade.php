          ...
          <div class="p-8">
              ...
              <div class="mt-6">
                  ...
                  <div class="mt-4 space-y-3">
                      ...
                      @foreach($socialProviders as $provider => $details)
                          <a href="{{ route('socialite.redirect', ['provider' => $provider]) }}"
                             class="w-full flex items-center justify-center py-2 px-4 border border-gray-300 rounded-md shadow-sm text-sm font-medium {{ $details['color'] }} bg-white hover:bg-gray-50">
                              {{ $details['name'] }}
                          </a>
                      @endforeach
                  </div>
