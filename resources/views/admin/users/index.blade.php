                            ...
                            <table class="min-w-full border border-gray-200">
                                ...
                                <tbody>
                                    @foreach($candidates as $candidate)
                                        <tr class="hover:bg-gray-100">
                                            <td class="px-4 py-2 text-center">
                                                <img src="{{ $candidate->profile_image ? asset('storage/' . $candidate->profile_image) : asset('default-avatar.png') }}"
                                                    alt="User Image" class="w-12 h-12 rounded-full mx-auto">
                                            </td>
                            ...
                            <table class="min-w-full border border-gray-200">
                                ...
                                <tbody>
                                    @forelse($employers as $employer)
                                        <tr class="hover:bg-gray-100">
                                            <td class="px-4 py-2 text-center">
                                                <img src="{{ $employer->profile_image ? asset('storage/' . $employer->profile_image) : asset('default-avatar.png') }}"
                                                    alt="User Image" class="w-12 h-12 rounded-full mx-auto">
                                            </td>
                            ...
                            <table class="min-w-full border border-gray-200">
                                ...
                                <tbody>
                                    @forelse($admins as $admin)
                                        <tr class="hover:bg-gray-100">
                                            <td class="px-4 py-2 text-center">
                                                <img src="{{ $admin->profile_image ? asset('storage/' . $admin->profile_image) : asset('default-avatar.png') }}"
                                                    alt="User Image" class="w-12 h-12 rounded-full mx-auto">
                                            </td>
