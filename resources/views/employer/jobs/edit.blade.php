                  ...
                  <form method="POST" action="{{ route('employer.jobs.update', $job->id) }}" class="space-y-6">
                      ...
                      <div>
                          ...
                          <select id="work_type" name="work_type" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500" required>
                              ...
                              <option value="hybrid" {{ old('work_type', $job->work_type) == 'hybrid' ? 'selected' : '' }}>Hybrid</option>                          </select>
                      ...
                      <div>
                          ...
                          <x-text-input id="application_deadline" name="application_deadline" type="date" class="mt-1 block w-full" value="{{ old('application_deadline', $job->application_deadline) }}" required />
                      ...
                      <div>
                          ...
                          <textarea id="description" name="description" rows="5" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500" required>{{ old('description', $job->description) }}</textarea>
                      ...
                      <div>
                          ...
                          <textarea id="responsibilities" name="responsibilities" rows="5" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500" required>{{ old('responsibilities', $job->responsibilities) }}</textarea>
                      ...
                      <div>
                          ...
                          <textarea id="requirements" name="requirements" rows="5" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500" required>{{ old('requirements', $job->requirements) }}</textarea>
                      ...
                      <div>
                          ...
                          <textarea id="benefits" name="benefits" rows="5" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">{{ old('benefits', $job->benefits) }}</textarea>
                              ...
                              @foreach($technologies as $technology)
                                  <div class="flex items-center">
                                      <input id="tech_{{ $technology->id }}" name="technologies[]" type="checkbox" value="{{ $technology->id }}" 
                                          ...
                                          {{ (is_array(old('technologies', $job->technologies->pluck('id')->toArray())) && in_array($technology->id, old('technologies', $job->technologies->pluck('id')->toArray()))) ? 'checked' : '' }}>
                      ...
                      <!-- Active Status -->
                      <div class="flex items-center">
                          <input id="is_active" name="is_active" type="checkbox" class="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-500" {{ old('is_active', $job->is_active) ? 'checked' : '' }}>
                          <label for="is_active" class="ml-2 block text-sm text-gray-900">
                              {{ $job->is_approved ? 'Set job as active' : 'Publish immediately (subject to approval)' }}
                          </label>
                      </div>
