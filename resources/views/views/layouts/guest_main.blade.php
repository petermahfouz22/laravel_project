...
<body class="font-sans text-gray-900 antialiased bg-gray-50">
    ...
    @if (Route::has('login'))
        <nav class="fixed top-0 z-50 w-full px-6 md:px-12 py-4 bg-gray-900 bg-opacity-95 shadow-lg">
            <div class="container mx-auto flex justify-between items-center">
                <!-- Logo -->
                <a href="{{ route('welcome') }}"><div class="text-2xl font-bold text-white tracking-tight">JobFinder</div></a>
            ...
            <!-- Mobile Menu -->
            <div id="mobile-menu"class="hidden md:hidden flex flex-col items-center w-full bg-indigo-900 text-white p-6 space-y-4">
                ...
                <a href="{{ route('job_search') }}" class="text-white font-medium hover:text-teal-300 transition-colors">Discover Jobs</a>
    ...
    <footer class="bg-gray-900 text-white py-6 text-center">
        <div class="container mx-auto">
            <p class="text-sm">© {{ date('Y') }} JobFinder. All rights reserved.</p>
            <ul class="flex justify-center space-x-6 mt-3">
                <li><a href="{{ route('about') }}" class="text-white hover:text-teal-300 transition-colors">About</a>
                </li>
                <li><a href="{{ url('/privacy') }}" class="text-white hover:text-teal-300 transition-colors">Privacy
                        Policy</a></li>
                <li><a href="{{ route('contact us') }}" class="text-white hover:text-teal-300 transition-colors">Contact
                        Us</a></li>
            </ul>
        </div>
    </footer>
